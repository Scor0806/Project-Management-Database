...
<div class="column1" style="background-color:#E0FFFF;">	
	<h2><center><u>Tasks Tables</u></center></h2><br>
	<p>Back to <a href="prjmgt_home.html">PM Home</a></p><br>
	<button type="submit" onclick='location.href="?DisplayAllTasks=1"' style="margin:5px;">All Tasks</button>
	...
	<form name="udaForm" action="" method="post">
		<input type="submit" name="report_id" value="Report Task Id">
		:<input type="text" name="report_taskid" id="report_taskid" size="8" style="margin:5px;">	
		<hr><br><br>
		<input type="submit" name="update_id" value="Update Task Id">
		<input type="submit" name="add_id" value="Add Task Id" style="margin:7px;">	
